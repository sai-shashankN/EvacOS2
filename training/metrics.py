...
_METRICS_COLUMNS: list[str] = [
    ...
    "invalid_action_rate",
    "orchestrator_invalid_action_rate",
    "floor_agent_invalid_action_rate",
    "orchestrator_invalid_action_count",
    "floor_agent_invalid_action_count",
    "parse_error_rate",
    "orchestrator_parse_error_rate",
    "floor_agent_parse_error_rate",
    "parser_salvage_rate",
    "orchestrator_parser_salvage_rate",
    "floor_agent_parser_salvage_rate",
    "wait_rate",
    ...
    "priority_action_rate",
    "priority_directive_issue_rate",
    "family_fire_fraction",
    "family_flood_fraction",
    "family_gas_fraction",
    "episodes_seen",
    "watchdog_status",
    "watchdog_reason",
